...
export default function Footer() {
    return (
        <div className="col-12 mt-5 py-5" style={{ background: '#4DA6BE' }} id="contacto">
            <div className="col-10 m-auto my-3 d-flex justify-content-center my-5">
                <p className="h3 text-white">CICLOLEGAL.CL</p>
            </div>
            <div className="col-11 col-sm-8 col-md-12 col-lg-12 col-xl-10 m-auto mb-5 my-3 d-flex flex-column flex-md-row justify-content-center">
                <a className="col-12 col-md-3 mb-3 d-flex flex-row flex-md-column flex-xl-row align-items-center  justify-content-center"
                    ...
                    <Image className=" me-2 mb-2" alt='email' src={Mail} style={{ height: '30px', width: '30px' }}></Image>
                ...
                <a className="col-12 col-md-3 mb-3 d-flex flex-row flex-md-column flex-xl-row align-items-center  justify-content-center"
                    ...
                    <Image className=" me-2 mb-2" src={Wtsp} alt='whatsapp' style={{ height: '40px', width: '40px' }}></Image>
                    <p className="mb-0 h5 fw-semibold text-white  mb-2">
                        +569 5115 2534
                    </p>
                </a>
                <a className="col-12 col-md-3 mb-3 d-flex flex-row flex-md-column flex-xl-row align-items-center  justify-content-center"
                    ...
                    <Image className=" me-2 mb-2" src={Ig} alt='instagram' style={{ height: '30px', width: '30px' }}></Image>
                    <p className="mb-0 h5 fw-semibold text-white  mb-2">
                        ciclolegal.cl
                    </p>
                </a>
